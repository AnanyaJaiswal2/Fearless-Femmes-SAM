  ...
  return (
    <Layout>
      ...
      <section
        ...
        style={{
          backgroundImage: "url('/images/contact-banner1.jpeg')",
        }}
      >
        ...
        <div className="container-narrow max-w-2xl">
          ...
          >
            ...
            <form className="flex flex-col gap-4">
              ...
              <Button
                type="submit"
                className="gradient-purple text-primary-foreground rounded-xl border-0 mt-2"
              >
                Send Message
              </Button>
            </form>
        ...
        <div className="container-narrow max-w-xl text-center">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }}>
            ...
            <motion.div
              variants={fadeUp}
              custom={0}
              className="w-14 h-14 rounded-2xl gradient-purple flex items-center justify-center mx-auto mb-4"
            >
              <Bell className="h-7 w-7 text-primary-foreground" />
            </motion.div>

            <motion.h2 variants={fadeUp} custom={1} className="text-3xl font-bold mb-4">
              Stay Updated
            </motion.h2>

            <motion.p variants={fadeUp} custom={2} className="text-muted-foreground mb-6">
              Subscribe to our newsletter for safety tips, career opportunities, and community updates.
            </motion.p>
            ...
            <motion.div variants={fadeUp} custom={3} className="flex gap-3 max-w-sm mx-auto">
              ...
              />
              <Button className="gradient-purple text-primary-foreground rounded-xl border-0 shrink-0">
                Subscribe
              </Button>
            </motion.div>
